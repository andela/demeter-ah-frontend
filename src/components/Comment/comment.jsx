...
const EditComment = ({
  ...
  return (
    <div className="comment overflow-x-scroll flex pt-6 px-4 md:px-10">
      <img src={image || '/dummy.png'} className="authorImg shadow-md rounded-full object-cover w-16 h-16 mr-4" alt="" />
      <div className="commentInfo flex-grow">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col w-full my-2">
          ...
          <div className="reactions w-full flex flex-wrap items-center mt-2 ">
          ...
          {
            showHistory ? (
              <div ref={historyRef} className="edit-history shadow-md pt-2 min-w-80 overflow-x-scroll w-11/12 md:w-8/12">
